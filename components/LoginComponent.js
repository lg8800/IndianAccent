            ...
            <View style={styles.container}>
                ...
                <View style={styles.formButton}>
                    <Button
                        ...
                        buttonStyle={{ backgroundColor: "#fa0225"}}
                        />
                </View>
                <View style={styles.formButton}>
                    <Button
...
class RegisterTab extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            email: '',
            remember: false,
            imageUrl: baseUrl + 'images/indianaccent.png'
        }
    }

    getImageFromCamera = async () => {
        const cameraPermission = await Permissions.askAsync(Permissions.CAMERA);
        const cameraRollPermission = await Permissions.askAsync(CAMERA_ROLL);
